...
def test_die_frostschutzgrenze_heisst_nicht_wie_ihr_messwert(client_module):
    ...
    assert client_module.name_override(14, "3/23") == "Frostschutzgrenze Außentemperatur"
